<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="StartNetwork.ui.ftpserver.add" %>
                        ...
                        <asp:GridView ID="onlineTvListGridView" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover dataTable display" OnRowDataBound="onlineTvListGridView_RowDataBound">
                            <Columns>
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="OnlineTvServerIdLabel" runat="server" Text='<%#Eval("FtpServerId") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="FtpServerName" HeaderText=" Name" />
                                <asp:TemplateField HeaderText="Online FTP Server Link">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="TvServerLink" runat="server" NavigateUrl='<%#Eval("FtpserverLink") %>' Text='<%#Eval("FtpserverLink") %>' Target="_blank"></asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Image">
                                    <ItemTemplate>
                                        <asp:Image ID="imageLabel" runat="server" ImageUrl='<%#"~/FtpServerImage/"+Eval("FtpServerImage") %>' Height="60" Width="60" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
