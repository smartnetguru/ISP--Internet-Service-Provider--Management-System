<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="create.aspx.cs" Inherits="VersityFinalProject.settings.user.create" %>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Email :</label>
                                        <asp:TextBox ID="emailtextBX" runat="server" CssClass="form-control" required="required"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="passwordTxtBx" runat="server" TextMode="Password" CssClass="form-control" required="required"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>
                                            Re-Type Password :
                                <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="*" ControlToValidate="retypePassTxtBX" ControlToCompare="passwordTxtBx" ForeColor="Red"></asp:CompareValidator>
                                        </label>
                                        <asp:TextBox ID="retypePassTxtBX" runat="server" TextMode="Password" CssClass="form-control" required="required"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>User Group :</label>
                                        <asp:DropDownList ID="userRoleDrpDown" runat="server" CssClass="form-control">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <asp:Button ID="btnSave" runat="server" Text="Create" CssClass="btn btn-primary" OnClick="btnSave_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
