<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="view.aspx.cs" Inherits="StartNetwork.ui.ftpserver.view" %>
    ...
    <section class="content">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <i class="fa fa-eye"></i>
                      FTP Server view of <small>[<asp:Label ID="OnlineTvId" runat="server"></asp:Label>]</small>
