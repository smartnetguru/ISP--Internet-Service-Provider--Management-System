<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="ftpcollectionedit.aspx.cs" Inherits="StartNetwork.ui.ftpserver.ftpcollectionedit" %>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <asp:Button runat="server" ID="btnUpdate" Text="Update" CssClass="btn btn-primary" OnClick="btnUpdate_OnClick"/>
                        </div>
                    </div>
                </div>
                </div>
