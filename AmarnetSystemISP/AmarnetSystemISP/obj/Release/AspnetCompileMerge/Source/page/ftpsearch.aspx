<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ftpsearch.aspx.cs" Inherits="StartNetwork.page.ftpsearch" %>
    ...
    fjs.parentNode.insertBefore(js, fjs);
        ...
        <div class="header">
           ...
           <div class="wrap">
            <div class="custom-menu">
                <ul>
                    <a href="/page/ftp.aspx" style="color:#000000"><li>Home</li></a>
                    <li>Movies
                        <ul>
        ...
        <div class="main-content">
            ...
            <div class="video-details">
                ...
                <asp:Repeater runat="server" ID="searchResultRepeter">
                    <ItemTemplate>
                         <div class="row" style="padding-bottom: 4px;">
                    <div class="col-md-12">
                        <asp:Label runat="server" ID="ftpCollectionId" Visible="False" Text='<%#Eval("FTPcollectionId") %>'></asp:Label>
                        <div class="col-md-3">
                            <asp:Image runat="server" ID="collectionImage" ImageUrl='<%# "~/FtpCollectionImage/"+Eval("FTPcollectionImageName") %>' Height="80" Width="100"/>
                        </div>
                        <div class="col-md-4">
                            <h3><asp:Label runat="server" ID="lblTitle" Text='<%#Eval("FTPcollectionTitle") %>'></asp:Label></h3>
                        </div>
                        <div class="col-md-2">
                            <asp:Label runat="server" ID="catagoryLbl" Text='<%#Eval("FTPcollectionParentCatagory") %>'></asp:Label>
                        </div>
                        <div class="col-md-3">
                            <div class="col-md-12">
                                  <div class="col-md-4">
